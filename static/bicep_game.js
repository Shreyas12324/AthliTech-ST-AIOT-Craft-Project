...
let mlcPrediction = 0x00; // Default to Good Form
...
function drawMLCPrediction() {
    ...
    // MLC Mapping
    let mlcMap = {
        0x00: "✅ Good Form - Keep going!",
        0x04: "⏸️ Standby - Ready to start",
        0x08: "❌ Bad Form - Correct your position"
    };
...
async function fetchSensorData() {
    try {
        ...
        let mappedPos = constrain((accelY + 960) / 1810, 0, 1); 
        let smoothedPos = height - (mappedPos * (height - ballRadius));

        // ✅ Buffer for smooth transitions
